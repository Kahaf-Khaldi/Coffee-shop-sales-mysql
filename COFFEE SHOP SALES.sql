...
-- TOTAL ORDERS KPI - Month on Month DIFFERENCE AND MOM GROWTH in Sales
...
-- TOTAL ORDERS KPI - Month on Month DIFFERENCE AND MOM GROWTH in orders
...
-- Month on Month increase or dicrease in the total quantity sold
SELECT 
    MONTH(transaction_date) AS month,
